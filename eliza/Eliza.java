...
public class Eliza {
    ...
    /**
     * Starts a new chat.
     * Reads user input and generates response from it.
     */
    public void run() {
    ...
    /**
     * Process an input String s, and generates and returns a reply String.
     */
    ...
    /**
     * Transformation with pre entries. Returns farewell words if input String s contains
     * quit word; Otherwise try to match s with keys in keyList: if match, generates reply
     * by decomposing and reassembling, if failed, returns null.
     */
    ...
    /**
     * Try to match String s with decompose pattern in a given Key k.
     * Assembles and returns a reply if succeeded; otherwise returns null.
     */
     ...
     * (Substitute words from map.keySet() its value)
     */
