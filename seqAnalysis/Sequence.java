...
public class Sequence {
    ...
    private List<Character> seq = new ArrayList<Character>();    // the DNA sequence (A/a, T/t, G/g, C/c and N/any)
    ...
    /**
     * Draws a line in graph that represents the sequence,
    ...
    /**
     * Changes sequence to the reverse-complementary sequence.
    ...
    /**
     * Changes nucleotides to upper-case representation in sequence.
     */
    public void toUpper() {
        ArrayList<Character> newSeq = new ArrayList<Character>();
        for (char c : seq) {
    ...
    /**
     * Changes nucleotides to lower-case representation in sequence.
     */
    public void toLower() {
        ArrayList<Character> newSeq = new ArrayList<Character>();
        for (char c : seq) {
