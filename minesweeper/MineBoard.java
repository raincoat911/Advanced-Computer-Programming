...
public class MineBoard {
    ...
    /**
     * Opens cells around cell at (i, j).
     */
    ...
    /**
     * Flags cell at (i, j), and draws a flag on cell.
     */
    ...
    /**
     * Unflags cell at (i, j), and remove the flag on cell.
     */
    ...
    /**
     * Changes the flag counts on cells around cell (i, j)
     */
    ...
    /**
     * Converts 2D index (i, j) into 1D index
     */
    ...
    /**
     * Returns true if cell at (i, j) contains a mine
     */
    ...
    /**
     * Returns the number of mines surrounding the cell (i, j)
     */
    ...
    /**
     * Sets the number of mines surrounding the cell (i, j)
     */
    ...
    /**
     * Returns true if cell at (i, j) contains a flag
     */
    ...
    /**
     * Returns the number of flags surrounding the cell (i, j)
     */
    ...
    /**
     * Updates the count of flags around the cell (i, j)
     */
    ...
    /**
     * Returns true if cell at (i, j) is open
     */
    ...
    /**
     * Draws a open cell showing mineCount number
     */
    ...
    /**
     * Removes the flag from cell
     */
    private void clearFlag(int i, int j) {
        StdDraw.setPenColor(StdDraw.GRAY);
        StdDraw.filledSquare(j - 0.5, i - 0.5, 0.4);
    }
    
    /**
     * Draws a cell indicating a mistake open (open mine)
     */
