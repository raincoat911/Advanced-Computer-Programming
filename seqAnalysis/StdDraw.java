...
public class PlayGame {
    ...
    // Initialize a new PlayGame object
    public PlayGame() {	};
    
    /**
     * Starts a new minesweeper game with row = N1, col = N2, mine number = M.
     */
    public void play(int n1, int n2, int m) {
        N1 = n1;
        N2 = n2;
        M = m;
    ...
    /**
     * Initializes a new mine board and draws the board.
     */
    ...
    /**
     * Detects mouse input and update mine board.
     */
    private void mouseInput() {
        ...
        if (i > 0 && i < N1 + 1 && j > 0 && j < N2 + 1) {
            if (StdDraw.isLeftClick()) {  // if left mouse button is clicked
            ...
            else if (StdDraw.isRightClick()) {      // if right mouse button is clicked
                rightClick(i, j);
    ...
    /**
     * Performs left click operation on cell at (i, j), and
    ...
    /**
     * Performs right click operation on cell at (i, j).
     */
