...
public class MineSweeper extends JFrame implements MouseListener, ActionListener, ItemListener {
    ...
    // Initiate a new minesweeper game with default setting
    public MineSweeper() {
        // set the frame
    ...
    /**
     * Sets M mines randomly inside the board.
     */
    ...
    /**
     * Counts the number of adjacent mines for each square. (between 0 - 8)
     */
    ...
    /**
     * Sets the number of rows, cols and mines according to level choice.
     */
    ...
    /**
     * Converts timer counter to time text format
     */
    ...
    public void mouseReleased(MouseEvent e) {
        if (win) btnStart.setText("^o^");
            ...
            if (pressed) {
                pressed = false;
                pressAround(row, col, pressed);
            }
        }
    }
    
    /**
     * Performs left click operation on square at (i, j).
     */
    ...
    /**
     * Opens squares around square at (i, j).
     */
    ...
    /**
     * Presses squares around square at (i, j).
     */
    public void pressAround(int i, int j, boolean b) {
    ...
    /**
     * If b = true, draw shadow on square (i, j) by 1,
     * otherwise, clear shadow on square (i, j) by 1.
     */
    ...
    /**
     * Performs right click operation on square at (i, j).
     */
    ...
    /**
     * Changes the flag status on square at (i, j), and resets the minesLeft label.
     */
    ...
    /**
     * Changes the flag counts on squares around square (i, j)
     */
    ...
    /**
     * If b = true, increases flag counts on square (i, j) by 1,
     * otherwise, decreases flag counts on square (i, j) by 1.
     */
    ...
    /**
     * If game won, flags all mines and opens the rest squares.
     */
    private void win() {
        timer.stop();
    ...
    /**
     * If game lost, opens all squares with mine.
     */
    private void lose() {
        timer.stop();
        for (int row = 1; row < N1 + 1; row++) {
    ...
    private class MineSquare extends JPanel {
        ...
        private boolean isShadow() { return shadow; }
        
        private void shadow(boolean b) { shadow = b; }
    ...
    /**
     * Returns a color of number label given the number
     */
