...
public final class CodonTable {
    ...
    /**
     * Returns the sequence of amino acids after translation of the DNA sequence
     * starting from site 0.
     */
    public String translate(Sequence seq) { return translate(seq, 0); }
    
    /**
     * Returns the sequence of amino acids after translation of the DNA sequence
     * starting from site shift. An unknown amino acid (when DNA sequence
     * contains 'N') is translated as 'X'.
     */
    ...
    /**
     * Shows the single letter code of amino acid sequence in console.
     */
